...
public class TrenoGUI extends JFrame{
    ...
    public TrenoGUI(Treno treno){
        ...
        aggiungiVagoneMerci.addActionListener(new AscoltaAggiungiVagone());
        ...
        aggiungiVagonePasseggeri.addActionListener(new AscoltaAggiungiVagone());
    ...
    class AscoltaAggiungiVagone implements ActionListener{
        @Override
        public void actionPerformed(ActionEvent e) {
            Vagone v = null;
            ImageIcon icona = null;
            if(e.getSource() == aggiungiVagoneMerci){
                v = new VagoneMerci();
                icona = new ImageIcon("vagone-merci.png"); //Immagine treno passeggeri
            }else{
                v = new VagonePasseggeri();
                icona = new ImageIcon("vagone-passeggeri.png"); //Immagine treno merci
            }
